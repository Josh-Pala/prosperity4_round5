...
# H13: AMBER fair value model (R²=0.90, resid_std=321 over 30k ticks)
# AMBER ≈ 31353.3 - 0.970*MAGENTA - 0.385*ORANGE - 0.617*RED - 0.167*YELLOW
...
UV_AMBER_TAKE_THRESHOLD = 400  # take when |fair - mid| exceeds this
...
class Trader:
    def run(self, state: TradingState):
        ...
        # ---- UV_VISOR_AMBER fair-value edge taker (H13) ----
