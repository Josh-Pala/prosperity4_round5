...
# OXYGEN_SHAKE_GARLIC fair-value model (top4). See eda5/oxygen_shake/garlic/.
GARLIC_INTERCEPT = 7857.22
GARLIC_BETAS = {
...
class Trader:
    def run(self, state: TradingState):
        ...
        # ---- OXYGEN_SHAKE_GARLIC cross-family fair-value edge taker (top4) ----
