"""
mm_pairs_full_v11pebbles_robotv2 — full universe with PEBBLES (v11) and
ROBOT (H25) optimized blocks.

Layers:
- General pair-trading: 12 non-ROBOT pairs from mm_pairs_full
  (PEBBLES_XS|PEBBLES_S removed; original 5 ROBOT pairs replaced)
- ROBOT H25 pairs (6, anchor diversified): merged into the same pair list
- Non-PEBBLES MM layer: 24 residual symbols
- PEBBLES block (dedicated, from v11): two pairs + constant-sum-aware MM

Standalone backtests on Round 5 days 2-4:
  - PEBBLES v11 alone: 139.218 (vs 78.427 with original single pair)
  - ROBOT H25 alone:    97.216 (vs 65.193 with original 5 pairs)
Expected combined PnL: ~654k (vs 622k v11pebbles, vs 562k mm_pairs_full).
"""
...
PAIRS: List[Tuple[str, str, str, float]] = [
    # --- non-ROBOT pairs (unchanged from mm_pairs_full_v11pebbles) ---
    ...
    # --- ROBOT H25 (6 pairs, replaces original 5; anchor diversified) ---
...
class Trader:
    def run(self, state: TradingState):
        ...
        # ---- Pair-trading layer (non-PEBBLES, includes ROBOT H25) ----
        ...
        # ---- MM layer (disjoint from pairs and PEBBLES) ----
