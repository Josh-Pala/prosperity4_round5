"""
mm_pairs_full_v3 — hybrid: robotv2 + passive-entry execution from v4.

Combines best parts of:
  - mm_pairs_full_v11pebbles_robotv2 (PEBBLES v11 + ROBOT H25)
  - mm_pairs_full_v4 (passive-entry / aggressive-exit pair leg execution)

Pair leg execution rule:
  - Reducing position (closing): aggressive (cross spread) — fill before signal fades
  - Building position (entering): passive (post inside spread, +1 / -1 from touch)
    saves ~half-spread per fill.
"""
