"""
mm_pairs_full_v3_1 — selective passive-entry execution.

Per-family backtest of v3 (full passive-entry) vs v2 (full aggressive) shows:
  - MICROCHIP   : passive +8,801 (adopt passive)
  - SNACKPACK   : passive +12,475 (adopt passive)
  - SLEEP_POD   : passive +6,205 (adopt passive)
  - TRANSLATOR  : passive +2,836 (adopt passive)
  - PANEL       : passive -1,528 (keep aggressive)
  - ROBOT (H25) : passive -31,638 (keep aggressive — short-lived signals,
                                    misses fills when posting passively)
  - PEBBLES v11 : passive +505 (adopt passive, marginal)

This version routes execution per-family using PASSIVE_ENTRY_FAMILIES.
"""
