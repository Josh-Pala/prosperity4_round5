"""
v01 — baseline 1: solo la coppia z-score XS|S (estratta da combined_v5_cv_robust).
Solo PEBBLES, niente altro. Per avere il numero pulito su 3 giorni.
"""
...
PAIRS = [("PEBBLES_XS", "PEBBLES_S", "spread", 2.0)]
LIMIT = 10
WARMUP = 500
EXIT_Z = 0.3
SIZE = 10
