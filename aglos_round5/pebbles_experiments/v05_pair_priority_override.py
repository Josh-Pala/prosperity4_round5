"""
v05 — Strict priority: pair takes ±10 on XS|S, MM only fills the leftover legs (M,L,XL).
Same as v03 but with cleaner separation. Sanity check that v03's perf is reproducible.
"""
...
class Trader:
    def run(self, state: TradingState):
        ...
        # MM on M, L, XL — fair from full invariant (using actual mids of XS, S)
