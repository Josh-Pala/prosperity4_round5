"""
v11 — FINAL: best PEBBLES strategy from sweep.
  - Pair P1: PEBBLES_XS | PEBBLES_S spread, entry_z=2.0
  - Pair P2: PEBBLES_S  | PEBBLES_M sum,    entry_z=2.8
  - When ANY pair is engaged on a leg, that leg is reserved to pair execution.
  - Other legs: constant-sum aware MM (taker + passive quotes anchored at fair).

Backtest Round 5 days 2-4: total +139.218 (d2=42.776, d3=45.896, d4=50.546).
"""
