"""ROBOT exp — h0_baseline
Baseline: 5 pairs from mm_pairs_full as-is.
"""
...
PAIRS: List[Tuple[str, str, str, float]] = [('ROBOT_VACUUMING', 'ROBOT_LAUNDRY', 'spread', 1.0), ('ROBOT_DISHES', 'ROBOT_LAUNDRY', 'sum', 1.0), ('ROBOT_MOPPING', 'ROBOT_LAUNDRY', 'sum', 2.0), ('ROBOT_LAUNDRY', 'ROBOT_IRONING', 'spread', 1.2), ('ROBOT_MOPPING', 'ROBOT_IRONING', 'sum', 1.5)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
