"""ROBOT exp — h1_diversified
Diversified anchor: top 5 pairs by EDA residual std. LAUNDRY appears in 2 (was 4).
"""
...
PAIRS: List[Tuple[str, str, str, float]] = [('ROBOT_LAUNDRY', 'ROBOT_VACUUMING', 'spread', 1.0), ('ROBOT_DISHES', 'ROBOT_VACUUMING', 'sum', 1.0), ('ROBOT_DISHES', 'ROBOT_LAUNDRY', 'sum', 1.5), ('ROBOT_IRONING', 'ROBOT_MOPPING', 'sum', 1.5), ('ROBOT_LAUNDRY', 'ROBOT_MOPPING', 'sum', 2.0)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
