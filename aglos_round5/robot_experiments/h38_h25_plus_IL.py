...
PAIRS: List[Tuple[str, str, str, float]] = [('ROBOT_LAUNDRY', 'ROBOT_VACUUMING', 'spread', 1.0), ('ROBOT_DISHES', 'ROBOT_VACUUMING', 'sum', 1.5), ('ROBOT_DISHES', 'ROBOT_LAUNDRY', 'sum', 1.5), ('ROBOT_IRONING', 'ROBOT_MOPPING', 'sum', 1.5), ('ROBOT_LAUNDRY', 'ROBOT_MOPPING', 'sum', 2.0), ('ROBOT_MOPPING', 'ROBOT_VACUUMING', 'sum', 1.2), ('ROBOT_IRONING', 'ROBOT_LAUNDRY', 'spread', 1.2)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
