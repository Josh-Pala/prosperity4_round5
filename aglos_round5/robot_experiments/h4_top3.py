"""ROBOT exp — h4_top3
Top-3 minimal: less leg-sharing, smaller portfolio.
"""
...
PAIRS: List[Tuple[str, str, str, float]] = [('ROBOT_LAUNDRY', 'ROBOT_VACUUMING', 'spread', 1.0), ('ROBOT_DISHES', 'ROBOT_VACUUMING', 'sum', 1.0), ('ROBOT_IRONING', 'ROBOT_MOPPING', 'sum', 1.5)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
