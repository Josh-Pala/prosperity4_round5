"""ROBOT exp — h7_aggressive_z
H1 with all entry_z = 0.8 (more trades, weaker signals).
"""
...
PAIRS: List[Tuple[str, str, str, float]] = [('ROBOT_LAUNDRY', 'ROBOT_VACUUMING', 'spread', 0.8), ('ROBOT_DISHES', 'ROBOT_VACUUMING', 'sum', 0.8), ('ROBOT_DISHES', 'ROBOT_LAUNDRY', 'sum', 0.8), ('ROBOT_IRONING', 'ROBOT_MOPPING', 'sum', 0.8), ('ROBOT_LAUNDRY', 'ROBOT_MOPPING', 'sum', 0.8)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
