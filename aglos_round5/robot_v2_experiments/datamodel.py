"""
Official Prosperity 4 datamodel — do not modify.
Source: https://imc-prosperity.notion.site/writing-an-algorithm-in-python (Appendix B)

This file is provided by IMC and imported by the simulation environment.
Keep it in sync with the version downloaded from the platform.
"""
import json
