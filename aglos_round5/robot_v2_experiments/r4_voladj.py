"""H4 Volatility-Adjusted Z. We compute a short-window EWMA of (sig - long_mean)^2
and scale entry_z by sqrt(short_var / long_var). A *low* short_vol regime → small
fluctuations are tradable, lower z bar; *high* short_vol → require deeper z."""
...
class Trader:
    def run(self, state: TradingState):
        ...
        for a, b, sign, entry_z in PAIRS:
            ...
            # Short EWMA variance around long-run mean
            sq = (sig - st["mean"]) ** 2
