"""TRANSLATOR exp — t28_t17_z08: T17 z=0.8 (very aggressive)"""
from __future__ import annotations
from typing import Dict, List, Tuple
import jsonpickle
from datamodel import Order, OrderDepth, TradingState

PAIRS: List[Tuple[str, str, str, float]] = [('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_GRAPHITE_MIST', 'spread', 0.8), ('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_VOID_BLUE', 'sum', 0.8), ('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'sum', 0.8), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_VOID_BLUE', 'spread', 0.8)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
