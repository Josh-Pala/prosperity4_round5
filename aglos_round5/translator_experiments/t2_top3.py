"""TRANSLATOR exp — t2_top3: top-3 EDA pairs"""
from __future__ import annotations
from typing import Dict, List, Tuple
import jsonpickle
from datamodel import Order, OrderDepth, TradingState

PAIRS: List[Tuple[str, str, str, float]] = [('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'sum', 1.2), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_VOID_BLUE', 'spread', 1.2), ('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_VOID_BLUE', 'sum', 1.2)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
