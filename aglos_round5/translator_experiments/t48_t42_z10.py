"""TRANSLATOR exp — t48_t42_z10: T42 (exit=0.2) z=1.0"""
from __future__ import annotations
from typing import Dict, List, Tuple
import jsonpickle
from datamodel import Order, OrderDepth, TradingState

PAIRS: List[Tuple[str, str, str, float]] = [('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_GRAPHITE_MIST', 'spread', 1.0), ('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_VOID_BLUE', 'sum', 1.0), ('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'sum', 1.0), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_VOID_BLUE', 'spread', 1.0), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_SPACE_GRAY', 'sum', 1.0)]
EXIT_Z = 0.2
SIZE = 10
WARMUP = 500
LIMIT = 10
