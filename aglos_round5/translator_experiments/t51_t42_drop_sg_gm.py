"""TRANSLATOR exp — t51_t42_drop_sg_gm: T42 minus SPACE_GRAY|GRAPHITE_MIST"""
from __future__ import annotations
from typing import Dict, List, Tuple
import jsonpickle
from datamodel import Order, OrderDepth, TradingState

PAIRS: List[Tuple[str, str, str, float]] = [('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_VOID_BLUE', 'sum', 1.2), ('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'sum', 1.2), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_VOID_BLUE', 'spread', 1.2), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_SPACE_GRAY', 'sum', 1.2)]
EXIT_Z = 0.2
SIZE = 10
WARMUP = 500
LIMIT = 10
