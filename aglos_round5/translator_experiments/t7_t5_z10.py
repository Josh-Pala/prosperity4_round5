"""TRANSLATOR exp — t7_t5_z1.0: T5 with all entry_z=1.0"""
from __future__ import annotations
from typing import Dict, List, Tuple
import jsonpickle
from datamodel import Order, OrderDepth, TradingState

PAIRS: List[Tuple[str, str, str, float]] = [('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'sum', 1.0), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_VOID_BLUE', 'spread', 1.0), ('TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'sum', 1.0), ('TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'sum', 1.0), ('TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_GRAPHITE_MIST', 'sum', 1.0)]
EXIT_Z = 0.3
SIZE = 10
WARMUP = 500
LIMIT = 10
